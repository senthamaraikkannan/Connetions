 ...
 * Time: 11:54 AM
 */
public class ActivityCountQueryResultHandler extends QueryResultHandler<CypherQueryParam, UserAndActivityCount> {

    public List<UserAndActivityCount> getResults(final Result result, final CypherQueryParam cypherQueryParam) {
        ...
        return userActivityCountList.stream()
                ...
                .limit(cypherQueryParam.getLimit()).collect(Collectors.toList());
    }
}
